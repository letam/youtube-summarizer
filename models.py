...
class Transcript(db.Model):
    ...
    summaries = db.relationship('Summary', backref='transcript', lazy=True, cascade='all, delete-orphan')
...
class Summary(db.Model):
    ...
    summary_type = db.Column(db.String(50), nullable=False)  # e.g., 'concise', 'detailed', 'key_points'
